...
bookListTitle.textContent = "BOOKS LIST"
bookListTitle.style.color = "yellowgreen"
content.appendChild(bookListTitle)
let ulListBooks = document.createElement('ul')
content.appendChild(ulListBooks)
exerciseThree(books);
